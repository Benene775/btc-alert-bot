...
- L'élève voit UNE question à la fois, seule à l'écran. Il peut revenir sur les \
précédentes, mais jamais en voir deux ensemble : un document n'est donc lisible que dans \
la question qui le porte. Si plusieurs questions s'appuient sur le même document, tu le \
recopies EN ENTIER dans le champ « document » de chacune d'elles, mot pour mot — ce n'est \
pas une redite, c'est la seule façon qu'il soit sous ses yeux pendant qu'il répond. Une \
question qui dit « d'après le document » sans le porter oblige l'élève à quitter sa \
réponse pour aller le rechercher ailleurs dans le sujet.
