...
/* Le quiz éclair sur la séquence Turismo y Madrid. Les fausses propositions
   sont les erreurs que ces deux points provoquent vraiment : l'accent qui
   disparaît, et le futuro hipotético traduit par un futur français. */
const QUIZ = [
  {
    numero: 1,
    enonce: 'Comment s’écrit correctement cette exclamation ?',
    propositions: ['¡Que bonito!', '¡Qué bonito!', '¡Que bonito?', 'Qué bonito!'],
    juste: 1,
    pourquoi_juste: 'Le mot exclamatif porte toujours l’accent écrit : qué, quién, cómo, cuánto.',
    pourquoi_faux: [
      'Sans accent, « que » est un relatif, pas un exclamatif. C’est l’accent qui fait la différence.',
      '',
      'Une exclamation se ferme par « ! », pas par « ? ».',
      'Il manque le « ¡ » d’ouverture : en espagnol, l’exclamation s’ouvre et se ferme.',
    ],
    notion: 'Los acentos de la frase exclamativa',
    chapitre: 'Turismo: luces y sombras',
    ou_dans_le_cours: 'La frase exclamativa, dans ta fiche.',
  },
  {
    numero: 2,
    enonce: 'Que veut dire « Estará fascinado por Madrid » ?',
    propositions: [
      'Il sera fasciné par Madrid',
      'Il doit être fasciné par Madrid',
      'Il était fasciné par Madrid',
      'Qu’il soit fasciné par Madrid',
    ],
    juste: 1,
    pourquoi_juste: 'C’est le futuro hipotético : le futur y exprime une hypothèse sur le présent.',
    pourquoi_faux: [
      'C’est le piège n°1 : traduire le futuro hipotético par un futur français. Ici on parle du présent.',
      '',
      'Le passé demanderait « estaba ». La forme est bien un futur.',
      'Le subjonctif demanderait « esté ». Ce n’est pas la forme employée.',
    ],
    notion: 'El futuro hipotético',
    chapitre: 'Madrid, capital cultural e histórica',
    ou_dans_le_cours: 'El futuro hipotético, dans ta fiche.',
  },
  {
    numero: 3,
    enonce: 'Qu’est-ce que le turismo comunitario, d’après ton cours ?',
    propositions: [
      'Le tourisme organisé par les communes espagnoles',
      'Un tourisme géré par les habitants, dont les bénéfices restent sur place',
      'Le tourisme des ressortissants de l’Union européenne',
      'Un tourisme réservé aux groupes scolaires',
    ],
    juste: 1,
    pourquoi_juste: 'Ce sont les habitants qui accueillent, et l’argent reste dans le village.',
    pourquoi_faux: [
      'Piège du faux ami : « comunitario » ne renvoie pas à la commune.',
      '',
      'Autre faux ami : « comunitario » ne désigne pas ici la Communauté européenne.',
      'Rien dans ton cours ne le réserve aux scolaires.',
    ],
    notion: 'El turismo comunitario',
    chapitre: 'Turismo: luces y sombras',
    ou_dans_le_cours: 'El turismo comunitario, deuxième partie de ta fiche.',
  },
  {
    numero: 4,
    enonce: 'Dans ton cours, quel est le principal reproche fait au tourisme de masse ?',
    propositions: [
      'Il fait monter les loyers et chasse les habitants',
      'Il rapporte trop peu d’argent au pays',
      'Il empêche l’apprentissage des langues',
      'Il ferme les musées le dimanche',
    ],
    juste: 0,
    pourquoi_juste: 'C’est le cœur du débat « luces y sombras » de ta séquence.',
    pourquoi_faux: [
      '',
      'Au contraire : le cours donne des chiffres qui montrent combien il rapporte.',
      'Ce n’est pas un argument de ton cours.',
      'Rien de tel dans tes pages.',
    ],
    notion: 'El turismo en España: cifras y debate',
    chapitre: 'Turismo: luces y sombras',
    ou_dans_le_cours: 'El turismo en España, première partie de ta fiche.',
  },
  {
    numero: 5,
    enonce: 'Quel accent porte « cuánto » dans une question ou une exclamation ?',
    propositions: [
      'Aucun : cuanto s’écrit toujours sans accent',
      'Un accent sur le « a »',
      'Un accent sur le « u »',
      'Un accent seulement au pluriel',
    ],
    juste: 2,
    pourquoi_juste: 'Comme qué, quién et cómo : l’accent tombe sur la voyelle tonique.',
    pourquoi_faux: [
      'Sans accent, « cuanto » est un relatif. En question ou en exclamation, il en prend un.',
      'L’accent ne tombe pas sur le « a » : la syllabe tonique est « cuán ».',
      '',
      'Le nombre n’y change rien : cuántos aussi porte l’accent.',
    ],
    notion: 'Los acentos de la frase exclamativa',
    chapitre: 'Turismo: luces y sombras',
    ou_dans_le_cours: 'La frase exclamativa, dans ta fiche.',
